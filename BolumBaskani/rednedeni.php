...
if (isset($_GET['ID'])) {
  ...
  if(isset($_POST['Reddet']))
  {
    ...
    $UPDATE =$VeritabaniBaglantisi->prepare("UPDATE ogrenciler SET StajOnay=?, StajOnayBaskan=?, OgrenciStajBasvuru=?, OgrenciStajGonderim=?, ReddetmeYorumu=? WHERE Ogrenci_id=?");
  $UPDATE->execute(array(2,2,0,0,$redSebebi, $GelenID));
        ...
        <nav class="nav">
            <div> <a href="AnaPanel_Danisman.php" class="nav_logo"><span class="nav_logo-name"><img src="../resimler/ktun_logo_koyu_zemin.gif" height="40"></span> </a>
                <div class="nav_list"> <a href="AnaPanel_Danisman.php" class="nav_link" style="text-decoration:none;"> <i class='bi bi-house-door nav_icon'></i> <span class="nav_name">Anasayfa</span> </a>
                   ...
                   <a href="onay_bekleyen_stajlar.php" class="nav_link active" style="text-decoration:none; text-align: center;"> <i class='bi bi-person-check nav_icon'></i> <span class="nav_name">Onay Bekleyen<br>Stajlar</span> </a>

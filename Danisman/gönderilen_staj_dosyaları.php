...
?>
        ...
        <nav class="nav">
            <div> <a href="AnaPanel_Danisman.php" class="nav_logo"><span class="nav_logo-name"><img src="../resimler/ktun_logo_koyu_zemin.gif" height="40"></span> </a>
                <div class="nav_list"> <a href="AnaPanel_Danisman.php" class="nav_link" style="text-decoration:none;"> <i class='bi bi-house-door nav_icon'></i> <span class="nav_name">Anasayfa</span> </a>
                   ...
                   <a href="gönderilen_staj_dosyaları.php" class="nav_link active" style="text-decoration:none; text-align: center;"> <i class="bi bi-journal-check nav_icon"></i> <span class="nav_name">Staj Dosyaları</span> </a>
    ...
    <div class="row">
 <div class="col-8" style="margin-top: 80px;"><h3>Gönderilen Staj Dosyaları</h3></div>
 <div class="col-4" style="margin-top: 80px; text-align: right;"> <form action="ogrenci_bul.php" method="GET" role="form" class="d-flex" style="margin-left: 20px; width:300px;">
    ...
    <div style="border-top:2px solid blue; padding: 20px;">
      <table class="table table-dark table-striped">
 		...
 		<?php
        $ogrenci_sor =$VeritabaniBaglantisi->prepare("SELECT * FROM ogrenciler JOIN stajdosyasi ON  ogrenciler.Ogrenci_id= stajdosyasi.stajdosyasi  WHERE ogrenciler.Danisman_SicilNo=? ORDER BY Ogrenci_id ASC");
     $ogrenci_sor->execute(array($girenDanisman));
        ...
        <tr>
            ...
            <td><?php echo $row['Ogrenci_Email']; ?></td>
              <td><a href="stajdosyası.php?ID=<?php echo $row['Ogrenci_id'];?>" style="text-decoration: none; color:#4B7BE5;"><?php echo $row['Ogrenci_dosya']; ?></a></td>

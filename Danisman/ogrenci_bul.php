...
$aranan_ogrenci = $_GET['arananOgrenci'];
		...
		$ogrenci_sor =$VeritabaniBaglantisi->prepare("SELECT * FROM ogrenciler WHERE Ogrenci_adi LIKE ? AND Danisman_SicilNo=? AND Silinme_Durumu=?");
                                    $ogrenci_sor->execute(array("%$aranan_ogrenci%",$girenDanisman,0));

...
<body>
        ...
        <div style="border: 1px solid; border-color:white; border-radius: 20px; margin:100px 0px 0px 400px; width: 500px; height:420px; padding:10px 0px 10px 15px; background-color:white; box-shadow: 3px 3px 4px #000;">
           <h5 style="color:#0E185F;">Staj Takip Sistemi Bolum Başkanı Giriş Sayfası</h5>
           <p style="color:#0E185F;">Sisteme giriş yapmak için bilgilerinizi giriniz.</p> <hr>
           <div class="mt-3" style=" text-align:center;"><img src="resimler/bolum_baskani.png"></div>
         <form action="giris_sonuc2.php" method="post">
    <div class="input-group mb-3 mt-2" style="width: 400px;"> 
  ...
  <input type="mail" name="EmailAdresi" class="form-control" placeholder="E-mail adresinizi giriniz">
</div>

...
<body id="body-pd">
    ...
    <?php
    echo '<script>Swal.fire("Ekleme Başarısız", "Öğrenci kayıt/kayıtları eklenirken bir hata oluştu.Öğrenci Ekleme sayfasına yönlendiriliyorsunz...", "error"); </script>';
      header("Refresh: 4; url=Ogrenci_ekle.php");
    ?>
